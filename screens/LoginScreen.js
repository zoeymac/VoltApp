      ...
      >
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('Signup', { mode: 'driver' })}
          >
            <Ionicons name="car-sport-outline" size={16} color={GOLD} />
            <Text style={styles.driverLinkText}>Want to drive? Apply here →</Text>
          </TouchableOpacity>
        </View>

        <Text style={styles.privacyNote}>
          By signing in you agree to our{' '}
          <Text style={styles.privacyLink} onPress={() => navigation.navigate('TermsOfService')}>
            Terms of Service
          </Text>
          {' '}and{' '}
          <Text style={styles.privacyLink} onPress={() => navigation.navigate('PrivacyPolicy')}>
            Privacy Policy
          </Text>
        </Text>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  driverLinkText: { fontSize: 14, fontWeight: '600', color: GOLD },
  privacyNote: {
